...
export const TUNABLES = {
  ...
  closeTargetRange: 1.75,
  targetConeDot: 0.08,
  cameraTargetBonus: 0.55,
  movementTargetAssistWeight: 0.35,
  targetStickyBonus: 1.35,
  logTargetPriorityPenalty: 0.95,
  swingMaxHits: 3,
  swingArcDot: 0.22,
  ...
  comboFallImpulseMultiplier: 1.28,
  overkillFallImpulseMultiplier: 0.42,
  fallDuration: 1.15,
  ...
  treeSweepSurvivorDamping: 0.82,
  treeSweepCascadeDamping: 0.94,
  playerRadius: 0.58,
